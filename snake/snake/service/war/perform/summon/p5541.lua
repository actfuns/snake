...
function CalMagDefensed(iPerform, oAttack, oVictim, oUsePerform)
    ...
    local iDefense = oVictim:QueryAttr("mag_defense") * iRatio / 100
...
function CPerform:CalWarrior(oAction, oPerformMgr)
    ...
    local func = function (oAttack, oVictim, oUsePerform)
        return CalMagDefensed(iPerform, oAttack, oVictim, oUsePerform)        
    end
    oAction:AddFunction("CalMagDefensed", self.m_ID, func)
end
