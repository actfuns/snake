...
void
memory_purge_unused(void) {
	int ret = je_mallctl("arena." STRINGIFY(MALLCTL_ARENAS_ALL) ".purge", NULL, NULL, NULL, 0);
	skynet_error(NULL, "lxldebug memory_purge_unused %d", ret);
}

void
memory_reset_unused(void) {
	int ret = je_mallctl("arena." STRINGIFY(MALLCTL_ARENAS_ALL) ".reset", NULL, NULL, NULL, 0);
	skynet_error(NULL, "lxldebug memory_reset_unused %d", ret);
}

void
memory_decay_unused(void) {
	int ret = je_mallctl("arena." STRINGIFY(MALLCTL_ARENAS_ALL) ".decay", NULL, NULL, NULL, 0);
	skynet_error(NULL, "lxldebug memory_decay_unused %d", ret);
}
